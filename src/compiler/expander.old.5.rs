// expander should use a vec of Ast instead of a BTree, then
// look up is a simple linear scan. lookups can be ordinal as well
// ast::graphs are just vecs, so they can be used for this purpose
